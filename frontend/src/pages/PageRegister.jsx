...
const PageRegister = () => {
    ...
    return (
        <Container
            fluid
            className="d-flex align-items-center justify-content-center bg-light px-3 my-4"
        >
                                    ...
                                    <>
                                        ...
                                        <Form.Group controlId="confirmPassword">
                                            <InputGroup className="rounded-3">
                                                ...
                                                >
                                                    <i
                                                        className={`fa-solid ${showPassword.confirm ? 'fa-eye-slash' : 'fa-eye'} text-muted`}
                                                    ></i>
                                                </Button>
                                            </InputGroup>
                                        </Form.Group>
                                    ...
                                    <>
                                        <div className="d-flex flex-column text-start gap-1">
                                            {mobilityOptions.map((opt) => {
                                                const isSelected =
                                                    formData.selectedMobility.includes(
                                                        opt.id,
                                                    );
                                                ...
                                                return (
                                                    <button
                                                        ...
                                                        className={`btn btn-sm w-100 d-flex align-items-center py-2 px-3 border-2 rounded-2 mb-2 ${
                                                            isSelected
